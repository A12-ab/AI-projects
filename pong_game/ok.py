...
class GameSelectorApp:
    def __init__(self, root):
        ...
        self.bg_image = Image.open('bk.jpg')  # Replace 'bk.jpg' with the path to your background image
        self.bg_photo = ImageTk.PhotoImage(self.bg_image)

        # Create a Canvas widget to display the background image
        canvas = tk.Canvas(root, width=self.bg_photo.width(), height=self.bg_photo.height())
        canvas.pack()
